...
int main()
{
    ...
    do
    {
        ...
        do
        {
            // effacer écran
            system("cls");
            cout << endl << "FEUILLES DE TD 5 & TP 5 - FICHIERS TEXTE - EXERCICE 2 - CALCUL MOYENNE PLUVIOMETRIQUE" << endl << endl;
        ...
        if (toupper(choix) == 'S')
        {
            ...
            cout << "moyenne des valeurs du fichier " << nomSysteme << " : " << moyennePluviometrique(nomSysteme) << endl;
