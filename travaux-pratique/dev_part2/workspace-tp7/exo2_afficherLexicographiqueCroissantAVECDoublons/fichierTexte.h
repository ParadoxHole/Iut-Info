#ifndef FICHIERSTEXTE
#define FICHIERSTEXTE
#include <iostream>
#include <fstream>
using namespace std;
...
/* Change le nom du fichier ou r�pertoire ancienNom par nouveauNom.
   Op�ration effectu�e directement sur le fichier, sans utilsiation de flot C++.
   Si ancienNom ou nouveauNom pr�cisent diff�rentes localisations (r�pertoires),
...
/* Supprime le fichier dont le nom syst�me est pr�cis� par le param�tre nom.
   Op�ration effectu�e directement sur le fichier, sans utilsiation de flot C++.
   Le fichier doit �tre *ferm�* pour que l'op�ration r�ussisse.
   Valeur retourn�e :
   . 0 si l'op�ration se d�roule correctement,
